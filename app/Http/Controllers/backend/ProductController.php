...
class ProductController extends Controller
{
    ...
    {
        $list_product = Product::join('ntt_product_image','ntt_product_image.product_id','=','ntt_product.id')
            ->where('ntt_product.status', '!=', 0)->orderBy('ntt_product.created_at', 'desc')->get();
