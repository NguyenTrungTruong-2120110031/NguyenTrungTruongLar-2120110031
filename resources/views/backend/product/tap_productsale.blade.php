<div class="row">
    <div class="col-md-12">
      <div class="mb-3">
        ...
        <input type="text" name="price_sale" value="{{old('price_sale')}}" id="price_sale" class="form-control" 
      ...
      <div class="mb-3">
        ...
        <input type="date" name="date_begin" value="{{old('date_begin')}}" id="date_begin" class="form-control" 
